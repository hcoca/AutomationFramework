...
public class VerifyCurrentDateInTo extends TestBaseSetup {
	...
	@Test
	public void testVerifyCurrentDateInToField(){
		LogManager.info("Executing: Verify current date in to field test case");

		
		loginPage = new LoginPage(driver);
 		homePage = loginPage.access(serviceURL, userName, password, roomName);
 		meetingsPage = homePage.selectSchedulePage(); 		
 		Assert.assertEquals(meetingsPage.verifyCurrentDateInToField(), currentDate);
